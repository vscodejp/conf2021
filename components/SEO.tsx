  ...
  return (
    <>
      <Head>
        ...
        <meta property="description" content={i18next.t('og_description') || description} />
        <meta property="og:site_name" content={conferenceName} />
        <meta property="og:type" content="website" />
        <meta property="og:description" content={i18next.t('og_description') || description} />
        ...
        <meta property="twitter:description" content={i18next.t('og_description') || description} />
