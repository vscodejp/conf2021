...
const Schedule: FC = () => {
  return (
    ...
    >
      ...
      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1000' }}>
        10:00
      </h2>
      ...
      >
        ...
        <span className={timetableStyles.sessionTime}>10:00 - 10:30</span>
        <span className={timetableStyles.sessionTrack}>Track: 1</span>
        <span className={timetableStyles.sessionPresentar}>Presenter</span>
      </div>
      ...
      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1100' }}>
        11:00
      </h2>
      ...
      >
        ...
        <span className={timetableStyles.sessionTime}>11:00 - 11:30</span>
        <span className={timetableStyles.sessionTrack}>Track: 1</span>
        <span className={timetableStyles.sessionPresentar}>Presenter</span>
      </div>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1200' }}>
        12:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1300' }}>
        13:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1400' }}>
        14:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1500' }}>
        15:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1600' }}>
        16:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1700' }}>
        17:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1800' }}>
        18:00
      </h2>

      <h2 className={timetableStyles.timeslot} style={{ gridRow: 'time-1900' }}>
        19:00
      </h2>
    </div>
  )
